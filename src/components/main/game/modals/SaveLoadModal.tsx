...
import { Download, Upload, Database, X, Bug } from 'lucide-react';
...
export const SaveLoadModal: React.FC<SaveLoadModalProps> = ({ isOpen, onClose, onSaveGame, onLoadGame, onExitToMenu }) => {

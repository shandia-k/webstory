...
/**
 * MessageList is memoized to prevent re-renders when the parent ChatOverlay
 * updates its local input state. The list only updates when messages change.
 */
const MessageList = memo(function MessageList({ messages, isTyping, isOpen }) {

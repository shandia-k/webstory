 ...
 * Wrapped in React.memo to prevent re-renders when parent state (like input) changes.
 * This ensures that typing in the chat input doesn't cause the entire message history to re-render.
 */

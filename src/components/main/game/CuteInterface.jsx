            ...
            <div className="relative z-10 w-full max-w-sm h-screen md:h-[85vh] md:max-w-6xl md:aspect-[16/9] bg-white/60 backdrop-blur-xl md:rounded-[3rem] shadow-2xl md:border-8 border-white p-6 md:p-8 flex flex-col md:flex-row justify-between transition-all duration-500">
                ...
                <div className="flex-1 flex flex-col items-center justify-center relative md:w-5/12 order-2 md:order-1">
                    <div
                        ...
                        className={`text-[150px] md:text-[220px] filter drop-shadow-xl cursor-pointer select-none transition-transform outline-none focus-visible:scale-110 focus-visible:drop-shadow-2xl ${isBouncing ? 'animate-squish' : 'animate-float'}`}
                ...
                <div className="flex flex-col gap-6 md:w-6/12 order-1 md:order-2">
                    ...
                    <header className="flex justify-between items-center px-1">
                        ...
                        <div className="flex items-center gap-3">
                            <div
                                className="flex items-center gap-2 bg-yellow-100 px-4 py-2 rounded-full shadow-inner"
                                aria-label={`Current gold: ${wallet?.gold || 0}`}
                            >
                                <Star size={18} className="text-yellow-500 fill-yellow-500" />
                                <span className="font-bold text-yellow-700" aria-hidden="true">{wallet?.gold || 0}</span>
                            </div>
                            <button

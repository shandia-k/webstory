    ...
    return (
        <div className={`w-full h-screen bg-gradient-to-b ${bgGradient} transition-colors duration-1000 flex items-center justify-center font-cute text-gray-700 overflow-hidden relative`}>
                    ...
                    <header className="flex justify-between items-center px-1">
                        <div className="flex flex-col gap-1">
                            ...
                            >
                                ...
                                <div className="w-full bg-slate-200 border border-slate-300 h-2.5 rounded-full overflow-hidden" aria-hidden="true">
                                    <div
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <button
                                ...
                                className="p-3 bg-white rounded-full text-gray-400 hover:text-indigo-500 transition-colors shadow-sm active:scale-95 focus-visible:ring-2 focus-visible:ring-indigo-300 outline-none"
                            >
                                <Settings size={20} />
                            </button>
                            <button
                                aria-label="Music Settings"
                                className="p-3 bg-white rounded-full text-gray-400 hover:text-pink-500 transition-colors shadow-sm focus-visible:ring-2 focus-visible:ring-pink-300 outline-none"
                            >
                                <Music size={20} />
                            </button>
                        </div>
            ...
            <button
                ...
                className="absolute bottom-6 right-6 md:bottom-10 md:right-10 w-14 h-14 md:w-20 md:h-20 bg-gradient-to-tr from-pink-400 to-purple-400 rounded-full text-white shadow-lg flex items-center justify-center hover:scale-110 hover:rotate-12 transition-all z-50 animate-bounce focus-visible:ring-4 focus-visible:ring-purple-200 outline-none"
            >

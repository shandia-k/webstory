...
const StatPill = React.memo(function StatPill({ icon: Icon, value, color, barColor, label }) {
    ...
    useEffect(() => {
        if (value > prevValueRef.current) {
            ...
            setAnimClass('animate-shake-horizontal');
        }
...
const StatsDisplay = React.memo(function StatsDisplay({ happiness, energy, hunger, uiText }) {
    return (

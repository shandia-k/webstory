...
const StatPill = memo(function StatPill({ icon: Icon, value, color, barColor, label }) {
...
const StatsDisplay = memo(function StatsDisplay({ happiness, energy, hunger, uiText }) {
    return (

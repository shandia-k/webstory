...
import { Megaphone, Cookie, Frown, ShoppingBag, LucideIcon } from 'lucide-react';
...
const CommandButton: React.FC<CommandButtonProps> = ({ label, icon: Icon, color, onClick, disabled, desc }) => (
    <button
        onClick={onClick}
        disabled={disabled}
        className={`
...
interface CoachingMenuProps {
    onCommand: (cmd: string) => void;
    onItemClick: () => void;
    disabled: boolean;
}

const CoachingMenu: React.FC<CoachingMenuProps> = ({ onCommand, disabled, onItemClick }) => {
    return (

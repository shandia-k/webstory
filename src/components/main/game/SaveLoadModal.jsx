                    ...
                    <div className="space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                            <button
                                ...
                                className="group flex flex-col items-center justify-center gap-2 bg-gradient-to-br from-emerald-500 to-teal-600 text-white p-6 rounded-2xl shadow-lg hover:shadow-emerald-200 transition-all active:scale-95 hover:-translate-y-1 focus-visible:ring-4 focus-visible:ring-emerald-200 outline-none"
                            >
                        ...
                        <button
                            ...
                            className="w-full text-red-500 hover:bg-red-50 font-bold py-3 rounded-xl transition-colors border border-transparent hover:border-red-100 focus-visible:ring-4 focus-visible:ring-red-200 outline-none"
                        >
                            Exit to Main Menu
                        </button>
                    </div>

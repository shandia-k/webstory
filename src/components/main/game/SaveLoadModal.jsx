...
export function SaveLoadModal({ isOpen, onClose, onSaveGame, onLoadGame, onExitToMenu }) {
    ...
    useEffect(() => {
        if (isOpen) {
            // Focus the save button when modal opens
                    ...
                    <div className="space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <button
                                ...
                                aria-label="Load game from file"
                            >
                        ...
                        <button
                            ...
                            className="w-full text-red-500 hover:bg-red-50 font-bold py-3 rounded-xl transition-colors border border-transparent hover:border-red-100 focus-visible:ring-2 focus-visible:ring-red-300 focus-visible:outline-none"
                        >
                            Exit to Main Menu
                        </button>
                    </div>

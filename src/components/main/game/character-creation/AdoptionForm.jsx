...
const AdoptionForm = ({ onComplete, genre }) => {
    ...
    return (
        <div className="w-full h-screen md:h-screen bg-gradient-to-b from-blue-50 to-pink-50 font-fredoka flex items-center justify-center p-0 md:p-4 relative overflow-hidden">
            ...
            <div className="absolute top-10 left-10 text-white/60 animate-float-ui hidden md:block"><Cloud size={80} /></div>
            ...
            <div className="w-full h-screen md:h-auto md:max-w-5xl md:aspect-video bg-white/80 backdrop-blur-xl md:border-4 md:border-white md:rounded-[2.5rem] shadow-2xl overflow-hidden flex flex-col md:flex-row animate-pop-enter transition-all duration-500">
                ...
                `}>
                    ...
                    <div className="relative z-10 transition-transform duration-500">
                        <div className="text-[120px] md:text-[150px] animate-float-ui drop-shadow-2xl filter leading-none">

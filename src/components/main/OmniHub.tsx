            ...
            {adoptedPal && (
                <EvolutionModal
                    ...
                    onEvolve={(newData) => {
                        setAdoptedPal(prev => {
                            if (!prev) return null;
                            const currentStats = prev.role?.stats || {};
                            return {
                                ...prev,
                                name: newData.name,
                                // @ts-ignore
                                ...
                                role: {
                                    ...
                                    stats: {
                                        ...currentStats,
                                        maxHp: (currentStats.maxHp || 100) + 150,
                                        // Heal fully on evolve
                                        hp: (currentStats.maxHp || 100) + 150,
                                        atk: (currentStats.atk || 15) + 10,
                                        def: (currentStats.def || 10) + 5,
                                        // level: 1, // REMOVED: Keep level as requested
                                        // xp: 0     // REMOVED: Keep XP as requested
                                        evolutionStage: (currentStats.evolutionStage || 0) + 1
                                    }
                                }
                            };
                        });
